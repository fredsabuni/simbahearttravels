...
function BlogDetailsSingle() {
  return (
    <div className="blog-details-single">
                <img
                  src="assets/images/blog/blog-details-image.png"
                  className="img-fluid"
                  alt="image"
                />
                <p>
                  ...
                  wide range of biodiverse ecosystems. From the moss-laden Hoh
                ...
                <div className="row details-img-group g-4">
                  <div className="col-lg-4 col-md-4 col-sm-12">
                    <img
                      src="assets/images/blog/blog-details-img2.png"
                      className="img-fluid"
                      alt="image"
                    />
                  </div>
                  <div className="col-lg-4 col-md-4 col-sm-12">
                    <img
                      src="assets/images/blog/blog-details-img3.png"
                      className="img-fluid"
                      alt="image"
                    />
                  </div>
                  <div className="col-lg-4 col-md-4 col-sm-12">
                    <img
                      src="assets/images/blog/blog-details-img4.png"
                      className="img-fluid"
                      alt="image"
                    />
                  </div>
