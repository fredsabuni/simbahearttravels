...
function Banner3() {
  ...
  <div className="container">
    <div className="row justify-content-center align-items-center g-4">
      <div className="col-xl-7 col-lg-8 col-md-10 text-lg-start text-center">
        <div className="banner3-content">
          <span>Are you ready?</span>
          <h2>Best  &amp; Amazing Traveling in The WORLD.</h2>
          <p>Treat yourself with a journey to your inner self.</p>
          <Link href="/destination"><a  className="eg-btn btn--white btn--lg">Discover More</a></Link>
        </div> 
      </div>
      <div className="col-xl-5 col-lg-4 col-md-10">
        <div className="banner-form-box sibling-2">
